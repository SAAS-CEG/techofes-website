...
import Logo from "../assets/T77_logo.png";
...
const About = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center bg-red-900 p-5 md:p-10 overflow-hidden">
      <div
      ...
      >
        <img src={Logo} className="w-3/5"></img>
      </div>
    </div>
  );
};
