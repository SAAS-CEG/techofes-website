...
const ProEventCard = () => {
	...
	return (
		<div className="flex justify-center items-center m-11 gap-11">
			<div className="mx-10 glass w-96 h-96 bg-gradient-to-br rounded-2xl from-neutral-700 via-neutral-950 to-tranparent border border-gray-400" data-aos="fade-down-right">
			...
			<div className="mx-10 z-10 glass relative w-96 h-96 bg-gradient-to-br rounded-2xl from-neutral-700 via-neutral-950 to-tranparent border border-gray-400" data-aos="fade-up">
