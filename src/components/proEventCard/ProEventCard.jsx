...
const ProEventCard = () => {
  ...
  return (
    <div className="flex justify-center items-center m-11 gap-11">
      <div
        className="mx-10 z-10 glass w-80 h-96 bg-gradient-to-br rounded-2xl from-neutral-700 via-neutral-950 to-tranparent border border-gray-400"
      ...
      >
        ...
        <h1
          id="title"
          className="absolute -bottom-0 w-full text-4xl text-center"
        >
          CONCERT NIGHT
        </h1>
      </div>
      ...
      <div
        className="mx-10 z-10 glass relative w-80 h-96 bg-gradient-to-br rounded-2xl from-neutral-700 via-neutral-950 to-tranparent border border-gray-400"
        data-aos="fade-up"
      >
