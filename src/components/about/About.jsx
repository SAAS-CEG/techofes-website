		...
		<div className="flex flex-col md:flex-row justify-center items-center p-5 md:p-10 overflow-hidden">
			<div className={`w-full md:w-1/2 slide-in-left ${isVisibleLeft ? 'active' : ''}`}>
				...
				<div className="text-sm md:text-base text-justify">
					...
					entertainment and excitement. As students gather to celebrate innovation, artistry, and camaraderie, Techofes embodies the spirit of youthful enthusiasm and excellence.
				</div>
			</div>
			<div className={`w-full md:w-1/2 flex justify-center slide-in-right ${isVisibleRight ? 'active' : ''}`}>
