...
const About = () => {
  ...
  return (
    <div className="z-10 flex justify-center items-center p-2 md:p-10 ">
      <div className="w-full">
        <div className="glass p-8 border-none h-full">
          ...
          <div className="text-sm md:text-lg text-justify md:text-center font-thin tracking-wide font-viga">
            ...
            previous years, this year's event is anicipated to host with the
            theme "Eco Beats," where eco echoes Techofes's commitment to
            fostering global connections and sustainability and Beats resonates
            the music which is the common language of different cultures. The
            SAAS team cordially welcomes students from all over the country to
            participate in this year's Techofes to showcase their talent and
            create ever-green memories. We promise to take care of students from
            other colleges by giving proper accomodation facilities and meeting
