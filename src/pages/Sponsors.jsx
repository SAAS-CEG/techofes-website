    ...
    <div>
      ...
      <div className="h-full pb-11 mt-20 cursor-default">
        ...
        <div className="flex justify-center">
          <div className="flex flex-wrap w-4/5 p-5 md:p-10 border-4 rounded-xl mb-20">
            {imgs.map((el, index) => {
              return (
                <div
                  key={index}
                  className="w-full md:w-1/2 my-2 sm:px-2 lg:w-1/3 hover:scale-105 transition duration-300 ease-in-out"
                >
                  <div className="border-4 border-gray-200 rounded-xl shadow-lg bg-cover text-white">
                    <div
                      className="h-52 w-full object-contain rounded-t-lg bg-cover bg-center"
                      style={{ backgroundImage: `url(${el})` }}
                    ></div>
                    <div className="p-4 min-h-20">
                      <h5 className="mb-2 mt-2 text-xl text-center font-semibold font-unbounded tracking-tight">
                        Sponser Name
                      </h5>
                      <p className="h-14 text-center font-normal overflow-hidden">
                        Some description abt the sponser. Abt the org. and links
                        to their page.
                      </p>
                    </div>
                  </div>
