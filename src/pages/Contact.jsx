	...
	return (
		<div>
			<div className="h-screen flex justify-center items-center">
				<div className="justify-center items-center h-[600px] bg-gray-500 w-[800px] rounded-2xl p-4 shadow-2xl">
					<div className="flex-auto m-2">
						<h1 className="text-xl m-2">CONTACT</h1>
						<p className="text-sm md:text-base px-4">Lorem ipsum - +91 1234567890</p>
						<p className="text-sm md:text-base px-4">Lorem ipsum - +91 1234567890</p>
					</div>
					<div className="flex-auto m-2">
