...
const Home = () => {
	...
	return (
		<div className='bg-[#0f0f0f] cursor-default overflow-hidden'>
				...
				<div className='min-h-96 w-full pt-14 md:pt-0 md:min-h-[100vh] flex flex-col justify-center bg-sea1 bg-fixed bg-no-repeat bg-cover bg-center items-center overflow-hidden backGround'>
					...
					>
						{!hover && (
							...
							>
								South India's Biggest <br /> Cultural Event is here!!
							</div>
						)}
						{hover && (
							<div
							...
							>
								<div
									id='title'
									className='text-8xl text-left w-2/3'
								>
									South India's <br />
									Biggest <br />
									Cultural Event <br />
			...
			<div className='bg-black h-full md:h-full text-white flex flex-col justify-center item-center  md:py-20'>
			...
			{/* Celebrities Section */}
			{/* <div className=' Gradient background style : bg-gradient-to-r from-slate-900 to-slate-700'>
			...
			<Sponsors />
			<div className='text-center h-32 text-orange-400 text-6xl font-bold mt-20'>
				70+ INTERESTING EVENTS
			</div>
			Events Section
			<div className='bg-black h-[500px]	 bg-fixed bg-no-repeat bg-cover'>
				<Homeve />
			</div>
		</div>
	);
