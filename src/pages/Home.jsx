	...
	return (
		<div className="mt-20 bg-[#0f0f0f] cursor-default">
			...
			<div className="min-h-56 pt-14 md:pt-0 md:min-h-[90vh] flex flex-col justify-center items-center bg-sea1 bg-fixed bg-no-repeat bg-cover bg-center">
				<div onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} className="flex items-center">
					{!hover && (
			...
			<div className="bg-sea2 min-h-[525px] md:min-h-screen text-white bg-center bg-no-repeat bg-cover bg-fixed flex flex-col justify-center justify-between md:py-20">{/* <RevolveCarousel /> */}</div>

			{/* Celebrities Section */}
			<div className="bg-gradient-to-r from-slate-900 to-slate-700 min-h-screen bg-fixed bg-no-repeat bg-cover">
				<div className="py-10">
					<div className="text-center text-3xl font-bold md:text-6xl font-anta text-white">Celebrities</div>
			...
			<div className="min-h-[525px] md:min-h-screen text-white">
				<h1 className="text-3xl md:text-6xl text-center mt-10 font-anta">Proshows</h1>
				{/* <RevolveCarousel /> */}
				<ProEventCard />
			</div>
